...
# Read the CSV file
df = pd.read_csv('games_data.csv', usecols=['rank', 'review_data', 'percent_review', 'total_review'])
review_mapping = {
    'No Data': 10,
...
df = pd.read_csv('games_data2.csv', usecols=['rank', 'review_data', 'percent_review', 'total_review'])
